...
function Header() {
  return (
    <header className="w-screen lg:w-1/4 bg-gradient-to-b from-blue-700 to-blue-500 p-4 lg:px-14 lg:py-8 lg:bg-none lg:bg-blue-500 fixed z-10 shadow-sm lg:shadow-xl">
